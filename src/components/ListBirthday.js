...
export default function ListBirthday(props) {
    ...
    const [pasatBrithday, setPasatBrithday] = useState([]);
    ...
    const formatData = (items) => {
        ...
        setPasatBrithday(pasatBirthdayTempArray);
    };
    ...
    const deleteBirthday = (birthday) => {
        ...
        Alert.alert(
            'Eliminar cumpleaños',
            `¿Estas seguro de eliminar cumpleaños de ${birthday.name} ${birthday.lastname}?`,
            [
                {
                    text: 'Cancelar',
                    style: 'cancel'
